...
class UserAddressesControllerTest < ActionController::TestCase
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post :create, user_address: { City: @user_address.City, State: @user_address.State, Zip: @user_address.Zip, streetAddress: @user_address.streetAddress, userName: @user_address.userName }
    end
  ...
  test "should update user_address" do
    patch :update, id: @user_address, user_address: { City: @user_address.City, State: @user_address.State, Zip: @user_address.Zip, streetAddress: @user_address.streetAddress, userName: @user_address.userName }
    assert_redirected_to user_address_path(assigns(:user_address))
  end
